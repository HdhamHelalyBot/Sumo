  ...
  return (
    <div className="space-y-12">
      <section className="text-center bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md">
        <h2 className="text-4xl font-extrabold text-blue-600 dark:text-blue-400 mb-2">{t('home_title')}</h2>
      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          />
          <ProductCard
            icon={<WrenchScrewdriverIcon className="h-8 w-8 text-blue-600 dark:text-blue-400" />}
            title={t('product_lighting_tools')}
            description={t('product_lighting_tools_desc')}
          />
          <ProductCard
            icon={<PowerIcon className="h-8 w-8 text-blue-600 dark:text-blue-400" />}
